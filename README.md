...
**Live demo:** https://tskly.vercel.app
**Repo:** https://github.com/tushararora04/tskly (monorepo — frontend and backend in this single repository)
...
```bash
git clone https://github.com/tushararora04/tskly.git
cd tskly/backend
npm install
```
